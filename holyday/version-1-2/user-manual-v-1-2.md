...
![1 1 3 Administrator Role](/uploads/holyday/1-1-3-administrator-role.png "1 1 3 Administrator Role")
...
> 	<i>**FULL TIME:**</i> Absence all day (within their working hours).
   ...
   <i>**d) Start Date:**</i> Indicates the date in which initiates its absence.
	 <i>**e) End Date:**</i> Indicates the end date of your absence.
	 <i>**f) Reason:**</i> Is this section you can add a brief comment explaining why you are requesting permission absence. 
5. Select the name of the employee who is being recorded permissions. 
6. Select the main reason for the absence is recorded. 
7. Select the time period that lasted the employee's absence on the day. 
8. Enter the start date of the period of absence. 
9. Enter the end date of the period of absence. 
...
> 	<i>**v) Reset:**</i> Redirects to the individual holiday selection form that allows you to delete the days available for holidays not taken in a certain period. 
...
To make the respective discount must perform the following steps: 
1. Go to the individual employee Kardex you want to make the discount vacation days (Consult <a href="http://172.30.0.138/holyday/version-1-2/user-manual-v-1-2#3-3-2-employee-item">Item Employee</a> - <a href="http://172.30.0.138/holyday/version-1-2/user-manual-v-1-2#3-3-2-1-section-view">Section View</a> - <a href="http://172.30.0.138/holyday/version-1-2/user-manual-v-1-2#i-list-of-active-employees">List of active employees</a> - <a href="http://172.30.0.138/holyday/version-1-2/user-manual-v-1-2#vi-see-kardex-individual">View Kardex</a>). 
2. Select the "Compensation Hours" to see the form that allows the discount days. 
...
4. The information contained in the table can also be filtered based on some criteria: email or name associated employee. 
5. The table also allows us to move through the pages generated by any user list. 
6. In addition to these tools for visualization and filtering the list, also allow you to interact with each record thereof, through the following options: 
