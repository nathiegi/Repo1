...
To make the respective discount must perform the following steps: 
1. Go to the individual employee Kardex you want to make the discount vacation days (Consult <a href="http://172.30.0.138/holyday/version-1-2/user-manual-v-1-2#3-3-2-employee-item">Item Employee</a> - <a href="http://172.30.0.138/holyday/version-1-2/user-manual-v-1-2#3-3-2-1-section-view">Section View</a> - <a href="http://172.30.0.138/holyday/version-1-2/user-manual-v-1-2#i-list-of-active-employees">List of active employees</a> - <a href="http://172.30.0.138/holyday/version-1-2/user-manual-v-1-2#i-list-of-active-employees">View Kardex</a>). 
2. Select the "Compensation Hours" to see the form that allows the discount days. 
3. Select the "Reset Delays" option for discount vacation days accumulated delays over a period of time. This discount responds to established rules to see them in Item configuration - parameter list See for discount vacation days backlogs 